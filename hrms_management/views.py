    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if str(request.POST.get('user_type')) == "1":
                ...
                user.is_staff = False
            user.password = make_password(request.POST.get('gen_password'))
            user.new_password=request.POST.get('gen_password')
...
class ProvideAccessAndPermissionView(View):
    ...
    def post(self, request):
        ...
        if 'employee_services' in request.POST:
            ...
            if not 'hr_review_of_requirement_all' in request.POST and not 'hr_review_of_requirement_status' in request.POST:
            ...
            if 'hr_review_of_requirement_all' in request.POST or 'hr_review_of_requirement_status' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'hr_review_of_requirement_all' in request.POST and request.POST['hr_review_of_requirement_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                    user_per.recommended = True
                else:
                    for data in dict(request.POST)['hr_review_of_requirement_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "hr_review_of_requirement"
                user_per.sequence = 1
            ...
            if not 'approve_requirement_all' in request.POST and not 'approve_requirement_status' in request.POST:
            ...
            if 'approve_requirement_all' in request.POST or 'approve_requirement_status' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'approve_requirement_all' in request.POST and request.POST['approve_requirement_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                    ...
                    for data in dict(request.POST)['approve_requirement_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "approve_requirement"
                user_per.sequence = 1
            ...
            if not 'post_vacancies_internal_source_all' in request.POST and not 'post_vacancies_internal_source' in request.POST:
            ...
            if 'post_vacancies_internal_source_all' in request.POST or 'post_vacancies_internal_source' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'post_vacancies_internal_source_all' in request.POST and request.POST['post_vacancies_internal_source_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['post_vacancies_internal_source']:
                        if data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "internal_source"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 6
                user_per.save()


            if not 'post_vacancies_consultants_all' in request.POST and not 'post_vacancies_consultants' in request.POST:
            ...
            if 'post_vacancies_consultants_all' in request.POST or 'post_vacancies_consultants' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'post_vacancies_consultants_all' in request.POST and request.POST['post_vacancies_consultants_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['post_vacancies_consultants']:
                        if data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'post_vacancies_job_portal_all' in request.POST and not 'post_vacancies_job_portal' in request.POST:
            ...
            if 'post_vacancies_job_portal_all' in request.POST or 'post_vacancies_job_portal' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'post_vacancies_job_portal_all' in request.POST and request.POST['post_vacancies_job_portal_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['post_vacancies_job_portal']:
                        if data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "job_portal"
                user_per.sequence = 1
            ...
            if not 'post_vacancies_website_all' in request.POST and not 'post_vacancies_website' in request.POST:
            ...
            if 'post_vacancies_website_all' in request.POST or 'post_vacancies_website' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'post_vacancies_website_all' in request.POST and request.POST['post_vacancies_website_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['post_vacancies_website']:
                        if data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "website"
                user_per.sequence = 1
            ...
            if not 'post_vacancies_social_media_all' in request.POST and not 'post_vacancies_social_media' in request.POST:
            ...
            if 'post_vacancies_social_media_all' in request.POST or 'post_vacancies_social_media' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'post_vacancies_social_media_all' in request.POST and request.POST['post_vacancies_social_media_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['post_vacancies_social_media']:
                        if data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "social_media"
                user_per.sequence = 1
            ...
            if not 'post_vacancies_outsourcing_agencies_all' in request.POST and not 'post_vacancies_outsourcing_agencies' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 11).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 11)
            if 'post_vacancies_outsourcing_agencies_all' in request.POST or 'post_vacancies_outsourcing_agencies' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'post_vacancies_outsourcing_agencies_all' in request.POST and request.POST['post_vacancies_outsourcing_agencies_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "outsourcing_agencies"
                user_per.sequence = 1
            ...
            if not 'resume_receipt_online_all' in request.POST and not 'resume_receipt_online' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 12).delete()
            
            user_per = UserPermission.AddEditPermission(request, 1, 12)
            if 'resume_receipt_online_all' in request.POST or 'resume_receipt_online' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'resume_receipt_online_all' in request.POST and request.POST['resume_receipt_online_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['resume_receipt_online_all']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "online_resume"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 12
                user_per.save()

            if not 'resume_receipt_offline_all' in request.POST and not 'resume_receipt_offline' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 13).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 13)
            if 'resume_receipt_offline_all' in request.POST or 'resume_receipt_offline' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'resume_receipt_offline_all' in request.POST and request.POST['resume_receipt_offline_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['resume_receipt_offline']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "offline_resume"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 13
                user_per.save()

            if not 'resume_receipt_walk_in_all' in request.POST and not 'resume_receipt_walk_in' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 14).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 14)
            if 'resume_receipt_walk_in_all' in request.POST or 'resume_receipt_walk_in' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'resume_receipt_walk_in_all' in request.POST and request.POST['resume_receipt_walk_in_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['resume_receipt_walk_in']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "walkin_resume"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 14
                user_per.save()


            if not 'resume_screening_all' in request.POST and not 'resume_screening' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 15).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 15)
            if 'resume_screening_all' in request.POST or 'resume_screening' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'resume_screening_all' in request.POST and request.POST['resume_screening_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['resume_screening']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "screening"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 15
                user_per.save()

            if not 'interview_team_status_all' in request.POST and not 'interview_team_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 16).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 16)
            if 'interview_team_status_all' in request.POST or 'interview_team_status' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'interview_team_status_all' in request.POST and request.POST['interview_team_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['interview_team_status_all']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "interview_team"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 16
                user_per.save()

            if not 'behaviour_test_status_all' in request.POST and not 'behaviour_test_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 17).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 17)
            if 'behaviour_test_status_all' in request.POST or 'behaviour_test_status' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'behaviour_test_status_all' in request.POST and request.POST['behaviour_test_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.sequence = 1
                user_per.sub_menu_sequence = 17
                user_per.save()


            if not 'behaviour_test_result_status_all' in request.POST and not 'behaviour_test_result_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 18).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 18)
            if 'behaviour_test_result_status_all' in request.POST or 'behaviour_test_result_status' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'behaviour_test_result_status_all' in request.POST and request.POST['behaviour_test_result_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['behaviour_test_result_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "behaviour_test_result"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 18
                user_per.save()


    
            if not 'technical_test_status_all' in request.POST and not 'technical_test_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 19).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 19)
            if 'technical_test_status_all' in request.POST or 'technical_test_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'technical_test_status_all' in request.POST and request.POST['technical_test_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['technical_test_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "technical_interview"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 19
                    user_per.save()



            if not 'technical_test_result_status_all' in request.POST and not 'technical_test_result_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 20).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 20)
            if 'technical_test_result_status_all' in request.POST or 'technical_test_result_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'technical_test_result_status_all' in request.POST and request.POST['technical_test_result_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['technical_test_result_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "technical_result"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 20
                    user_per.save()



            if not 'hr_interview_status_all' in request.POST and not 'hr_interview_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 21).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 21)
            if 'hr_interview_status_all' in request.POST or 'hr_interview_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'hr_interview_status_all' in request.POST and request.POST['hr_interview_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['hr_interview_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "hr_interview"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 21
                    user_per.save()

            if not 'technical_interview_status_all' in request.POST and not 'technical_interview_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 22).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 22)
            if 'technical_interview_status_all' in request.POST or 'technical_interview_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'technical_interview_status_all' in request.POST and request.POST['technical_interview_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['technical_interview_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.sub_function_level = "technical_interview"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 22
                    user_per.save()

            if not 'final_interview_status_all' in request.POST and not 'final_interview_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 23).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 23)
            if 'final_interview_status_all' in request.POST or 'final_interview_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'final_interview_status_all' in request.POST and request.POST['final_interview_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['final_interview_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "final_interview"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 23
                    user_per.save()
              


            if not 'interview_status_all' in request.POST and not 'interview_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 24).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 24)
            if 'interview_status_all' in request.POST or 'interview_status' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'interview_status_all' in request.POST and request.POST['interview_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['interview_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'interview_result_status_all' in request.POST and not 'interview_result_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 25).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 25)
            if 'interview_result_status_all' in request.POST or 'interview_result_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'interview_result_status_all' in request.POST and request.POST['interview_result_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['interview_result_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "interview_result"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 25
                    user_per.save()

            


            if not 'salary_compensation_status_all' in request.POST and not 'salary_compensation_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 26).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 26)
            if 'salary_compensation_status_all' in request.POST or 'salary_compensation_status' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'salary_compensation_status_all' in request.POST and request.POST['salary_compensation_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['salary_compensation_status_all']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "salary_compensastion"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 26
                user_per.save()


            if not 'document_request_status_all' in request.POST and not 'document_request_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 27).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 27)
            if 'document_request_status_all' in request.POST or 'document_request_status' in request.POST:
                # user_per = UserAccessPermissonModelsPermission()
                user_per.user_id = request.POST['user_id']
                if 'document_request_status_all' in request.POST and request.POST['document_request_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['document_request_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 1
                user_per.function_level = "employee_services"
                user_per.sub_function_level = "document_request"
                user_per.sequence = 1
                user_per.sub_menu_sequence = 27
                user_per.save()


            if not 'upload_document_status_all' in request.POST and not 'upload_document_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 28).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 28)
            if 'upload_document_status_all' in request.POST or 'upload_document_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'upload_document_status_all' in request.POST and request.POST['upload_document_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['upload_document_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "upload_document"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 28
                    user_per.save()



            if not 'generate_offer_letter_status_all' in request.POST and not 'generate_offer_letter_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 29).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 29)
            if 'generate_offer_letter_status_all' in request.POST or 'generate_offer_letter_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'generate_offer_letter_status_all' in request.POST and request.POST['generate_offer_letter_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['generate_offer_letter_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "offer_letter"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 29
                    user_per.save()

            if not 'offer_approval_status_all' in request.POST and not 'offer_approval_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 30).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 30)
            if 'offer_approval_status_all' in request.POST or 'offer_approval_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'offer_approval_status_all' in request.POST and request.POST['offer_approval_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['offer_approval_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "offer_approval"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 30
                    user_per.save()



            if not 'issue_offer_letter_status_all' in request.POST and not 'issue_offer_letter_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 31).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 31)
            if 'issue_offer_letter_status_all' in request.POST or 'issue_offer_letter_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'issue_offer_letter_status_all' in request.POST and request.POST['issue_offer_letter_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    else:
                        for data in dict(request.POST)['issue_offer_letter_status']:
                            if  data == "1":
                                user_per.add = True 
                            if data == "2":
                                user_per.edit = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "issue_offer"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 31
                    user_per.save()

            if not 'active_resume_status_all' in request.POST and not 'resume_resceipt_online' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 32).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 32)
            if 'active_resume_status_all' in request.POST or 'resume_resceipt_online' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'active_resume_status_all' in request.POST and request.POST['active_resume_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "reseume_resceipt"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 32
                    user_per.save()

            if not 'blacklisted_resume_status_all' in request.POST and not 'blacklisted_resume_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 33).delete()
            user_per = UserPermission.AddEditPermission(request, 1, 33)
            if 'blacklisted_resume_status_all' in request.POST or 'blacklisted_resume_status' in request.POST:
                    # user_per = UserAccessPermissonModelsPermission()
                    user_per.user_id = request.POST['user_id']
                    if 'blacklisted_resume_status_all' in request.POST and request.POST['blacklisted_resume_status_all'] == "0":
                        user_per.add = True
                        user_per.edit = True
                        user_per.view = True
                        user_per.delete = True
                    ...
                    user_per.main_function = 1
                    user_per.function_level = "employee_services"
                    user_per.sub_function_level = "blacklisted_resume"
                    user_per.sequence = 1
                    user_per.sub_menu_sequence = 33
                    user_per.save()
...
################################################################################################################################
####################################### offer status #################################################################################
        # if not 'employee_offer_all' in request.POST and not 'employee_offer_status' in request.POST:
        #         UserAccessPermissonModelsPermission.objects.filter(main_function =1, sub_menu_sequence = 19).delete()
        # user_per = UserPermission.AddEditPermission(request, 1, 19)
        # if 'employee_offer_all' in request.POST or 'employee_offer_status' in request.POST:
        #         # user_per = UserAccessPermissonModelsPermission()
        #         user_per.user_id = request.POST['user_id']
        #         if 'employee_offer_all' in request.POST and request.POST['employee_offer_all'] == "0":
        #             user_per.add = True
        #             user_per.edit = True
        #             user_per.view = True
        #             user_per.delete = True
        ...
        #         user_per.main_function = 1
        #         user_per.function_level = "employee_services"
        #         user_per.sub_function_level = "offer"
        #         user_per.sequence = 1
        #         user_per.sub_menu_sequence = 19
        #         user_per.save()
...
########################################################################################################################################
        ...
        if 'boarding_exist_management' in request.POST:
            if not 'employee_update_consultnt_all' in request.POST and not 'employee_update_registeration' in request.POST:
            ...
            if not 'employee_verification_status_all' in request.POST and not 'employee_verification_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =2, sub_menu_sequence = 2).delete()
            
            user_per = UserPermission.AddEditPermission(request, 2, 2)
            if 'employee_verification_status_all' in request.POST or 'employee_verification_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_verification_status_all' in request.POST  and request.POST['employee_verification_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_verification_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 2
                user_per.function_level = "boarding_exist_management"
                user_per.sub_function_level = "employee_verification"
                user_per.sequence = 2
                user_per.sub_menu_sequence = 2
                user_per.save()


            if not 'employee_asset_allocation_status_all' in request.POST and not 'employee_asset_allocation_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =2, sub_menu_sequence = 3).delete()
            
            user_per = UserPermission.AddEditPermission(request, 2, 3)
            if 'employee_asset_allocation_status_all' in request.POST or 'employee_asset_allocation_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_asset_allocation_status_all' in request.POST  and request.POST['employee_asset_allocation_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_asset_allocation_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 2
                user_per.function_level = "boarding_exist_management"
                user_per.sub_function_level = "employee_asset_allocation"
                user_per.sequence = 2
                user_per.sub_menu_sequence = 3
                user_per.save()


            if not 'employee_relocation_status_all' in request.POST and not 'employee_relocation_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =2, sub_menu_sequence = 4).delete()
            
            user_per = UserPermission.AddEditPermission(request, 2, 4)
            if 'employee_relocation_status_all' in request.POST or 'employee_relocation_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_relocation_status_all' in request.POST  and request.POST['employee_relocation_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_relocation_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 2
                user_per.function_level = "boarding_exist_management"
                user_per.sub_function_level = "employee_relocation"
                user_per.sequence = 2
                user_per.sub_menu_sequence = 4
                user_per.save()


            if not 'employee_promotion_status_all' in request.POST and not 'employee_promotion_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =2, sub_menu_sequence = 5).delete()
            
            user_per = UserPermission.AddEditPermission(request, 2, 5)
            if 'employee_promotion_status_all' in request.POST or 'employee_promotion_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_promotion_status_all' in request.POST  and request.POST['employee_promotion_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_promotion_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 2
                user_per.function_level = "boarding_exist_management"
                user_per.sub_function_level = "employee_promotion"
                user_per.sequence = 2
                user_per.sub_menu_sequence = 5
                user_per.save()
        ...
        ####--------------------------------
        if 'off_boarding' in request.POST:

            if not 'employee_resignation_status_all' in request.POST and not 'employee_resignation_status' in request.POST:
            ...
            if 'employee_resignation_status_all' in request.POST or 'employee_resignation_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_resignation_status_all' in request.POST  and request.POST['employee_resignation_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_resignation_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'employee_termination_status_all' in request.POST and not 'employee_termination_status' in request.POST:
            ...
            if 'employee_termination_status_all' in request.POST or 'employee_termination_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_termination_status_all' in request.POST  and request.POST['employee_termination_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.main_function = 3
                user_per.function_level = "boarding_exist_management"
                user_per.sub_function_level = "employee_termination"
                user_per.sequence = 3
                user_per.sub_menu_sequence = 2
                user_per.save()
            ...
            if not 'employee_separation_status_all' in request.POST and not 'employee_separation_status' in request.POST:
            ...
            if 'employee_separation_status_all' in request.POST or 'employee_separation_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_separation_status_all' in request.POST  and request.POST['employee_separation_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_separation_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'employee_relieving_status_all' in request.POST and not 'employee_relieving_status' in request.POST:
            ...
            if 'employee_relieving_status_all' in request.POST or 'employee_relieving_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_relieving_status_all' in request.POST  and request.POST['employee_relieving_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_relieving_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 3
                user_per.function_level = "boarding_exist_management"
                user_per.sub_function_level = "employee_relieving"
                user_per.sequence = 3
                user_per.sub_menu_sequence = 4
                user_per.save()


            if not 'employee_full_and_final_status_all' in request.POST and not 'employee_full_and_final_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =3, sub_menu_sequence = 5).delete()
            
            user_per = UserPermission.AddEditPermission(request, 3, 5)
            if 'employee_full_and_final_status_all' in request.POST or 'employee_full_and_final_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_full_and_final_status_all' in request.POST  and request.POST['employee_full_and_final_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_full_and_final_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 3
                user_per.function_level = "boarding_exist_management"
                user_per.sub_function_level = "employee_F&F"
                user_per.sequence = 3
                user_per.sub_menu_sequence = 5
                user_per.save()


            if not 'employee_exit_interview_status_all' in request.POST and not 'employee_exit_interview_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =3, sub_menu_sequence = 6).delete()
            
            user_per = UserPermission.AddEditPermission(request, 3, 6)
            if 'employee_exit_interview_status_all' in request.POST or 'employee_exit_interview_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_exit_interview_status_all' in request.POST  and request.POST['employee_exit_interview_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_exit_interview_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 3
                user_per.function_level = "boarding_exist_management"
                user_per.sub_function_level = "employee_exit_interview"
                user_per.sequence = 3
                user_per.sub_menu_sequence = 6
                user_per.save()
        ...
        if 'employee_database' in request.POST:


            if not 'employee_active_status_all' in request.POST and not 'employee_active_status' in request.POST:
            ...
            if 'employee_active_status_all' in request.POST or 'employee_active_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_active_status_all' in request.POST  and request.POST['employee_active_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_active_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.function_level = "employee_database"
                user_per.sub_function_level = "active_employee"
                user_per.sequence = 4
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'employee_separated_status_all' in request.POST and not 'employee_separated_status' in request.POST:
            ...
            if 'employee_separated_status_all' in request.POST or 'employee_separated_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'employee_separated_status_all' in request.POST  and request.POST['employee_separated_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['employee_separated_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 4
                user_per.function_level = "employee_database"
                user_per.sub_function_level = "separated_employee"
                user_per.sequence = 4
                user_per.sub_menu_sequence = 2
                user_per.save()
        ...
        # -------------------
        if 'KRA_and_target' in request.POST:

            if not 'allocate_kra_status_all' in request.POST and not 'allocate_kra_status' in request.POST:
            ...
            if 'allocate_kra_status_all' in request.POST or 'allocate_kra_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'allocate_kra_status_all' in request.POST  and request.POST['allocate_kra_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['allocate_kra_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.function_level = "KRA_and_target"
                user_per.sub_function_level = "allocate_kra"
                user_per.sequence = 5
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'approve_kra_status_all' in request.POST and not 'approve_kra_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =5, sub_menu_sequence = 2).delete()
            user_per = UserPermission.AddEditPermission(request, 5, 2)
            if 'approve_kra_status_all' in request.POST or 'approve_kra_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'approve_kra_status_all' in request.POST  and request.POST['approve_kra_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['approve_kra_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 5
                user_per.function_level = "KRA_and_target"
                user_per.sub_function_level = "approve_kra"
                user_per.sequence = 5
                user_per.sub_menu_sequence = 2
                user_per.save()
            ...
            if not 'monitor_kra_status_all' in request.POST and not 'monitor_kra_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =5, sub_menu_sequence = 3).delete()
            user_per = UserPermission.AddEditPermission(request, 5, 3)
            if 'monitor_kra_status_all' in request.POST or 'monitor_kra_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'monitor_kra_status_all' in request.POST  and request.POST['monitor_kra_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['monitor_kra_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 5
                user_per.function_level = "KRA_and_target"
                user_per.sub_function_level = "approve_targets"
                user_per.sequence = 5
                user_per.sub_menu_sequence = 3
                user_per.save()
            ...
            if not 'fix_targets_status_all' in request.POST and not 'fix_targets_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =5, sub_menu_sequence = 4).delete()
            user_per = UserPermission.AddEditPermission(request, 5, 4)
            if 'fix_targets_status_all' in request.POST or 'fix_targets_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'fix_targets_status_all' in request.POST  and request.POST['fix_targets_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['fix_targets_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 5
                user_per.function_level = "KRA_and_target"
                user_per.sub_function_level = "fix_target"
                user_per.sequence = 5
                user_per.sub_menu_sequence = 4
                user_per.save()
            ...
            if not 'approve_target_status_all' in request.POST and not 'approve_target_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =5, sub_menu_sequence = 5).delete()
            user_per = UserPermission.AddEditPermission(request, 5, 5)
            if 'approve_target_status_all' in request.POST or 'approve_target_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'approve_target_status_all' in request.POST  and request.POST['approve_target_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['approve_target_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 5
                user_per.function_level = "KRA_and_target"
                user_per.sub_function_level = "approve_target"
                user_per.sequence = 5
                user_per.sub_menu_sequence = 5
                user_per.save()

            if not 'monitor_target_status_all' in request.POST and not 'monitor_target_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =5, sub_menu_sequence = 6).delete()
            user_per = UserPermission.AddEditPermission(request, 5, 6)
            if 'monitor_target_status_all' in request.POST or 'monitor_target_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'monitor_target_status_all' in request.POST  and request.POST['monitor_target_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['monitor_target_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 5
                user_per.function_level = "KRA_and_target"
                user_per.sub_function_level = "monitor_target"
                user_per.sequence = 5
                user_per.sub_menu_sequence = 6
                user_per.save()
...
# --------------------
        if 'working_day_and_time' in request.POST:
            if not 'working_days_status_all' in request.POST and not 'working_days_status' in request.POST:
            ...
            if 'working_days_status_all' in request.POST or 'working_days_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'working_days_status_all' in request.POST  and request.POST['working_days_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['working_days_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.function_level = "working_day_and_time"
                user_per.sub_function_level = "working_days"
                user_per.sequence = 6
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'working_time_status_all' in request.POST and not 'working_time_status' in request.POST:
            ...
            if 'working_time_status_all' in request.POST or 'working_time_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'working_time_status_all' in request.POST  and request.POST['working_time_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.main_function = 6
                user_per.function_level = "working_day_and_time"
                user_per.sub_function_level = "working_time"
                user_per.sequence = 6
                user_per.sub_menu_sequence = 2
                user_per.save()


            if not 'overtime_status_all' in request.POST and not 'overtime_status' in request.POST:
            ...
            if 'overtime_status_all' in request.POST or 'overtime_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'overtime_status_all' in request.POST  and request.POST['overtime_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['overtime_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 6
                user_per.function_level = "working_day_and_time"
                user_per.sub_function_level = "overtime"
                user_per.sequence = 6
                user_per.sub_menu_sequence = 3
                user_per.save()
...
#---------------------
        ...
        #     if not 'employee_exit_employee_recommendation_all' in request.POST and not 'employee_exit_employee_recommendation' in request.POST:
        #         UserAccessPermissonModelsPermission.objects.filter(main_function =4, sub_menu_sequence = 2).delete()
            
        #     user_per = UserPermission.AddEditPermission(request, 4, 2)
        #     if 'employee_exit_employee_recommendation_all' in request.POST or 'employee_exit_employee_recommendation' in request.POST:
        #         user_per.user_id = request.POST['user_id']
        #         if 'employee_exit_employee_recommendation_all' in request.POST  and request.POST['employee_exit_employee_recommendation_all'] == "0":
        #             user_per.add = True
        #             user_per.edit = True
        #             user_per.view = True
        #             user_per.delete = True
        #         else:
        #             for data in dict(request.POST)['employee_exit_employee_recommendation']:
        #                 if  data == "1":
        #                     user_per.add = True 
        #                 if data == "2":
        #                     user_per.edit = True
        ...
        #         user_per.main_function = 4
        #         user_per.function_level = "employee_exit"
        #         user_per.sub_function_level = "employee_recommendation"
        #         user_per.sequence = 4
        #         user_per.sub_menu_sequence = 2
        #         user_per.save()


        #     if not 'employee_exit_employee_approval_all' in request.POST and not 'employee_exit_employee_approval' in request.POST:
        ...
        #     if 'employee_exit_employee_approval_all' in request.POST or 'employee_exit_employee_approval' in request.POST:
        #         user_per.user_id = request.POST['user_id']
        #         if 'employee_exit_employee_approval_all' in request.POST  and request.POST['employee_exit_employee_approval_all'] == "0":
        #             user_per.add = True
        #             user_per.edit = True
        #             user_per.view = True
        #             user_per.delete = True
        #         else:
        #             for data in dict(request.POST)['employee_exit_employee_approval']:
        #                 if  data == "1":
        #                     user_per.add = True 
        #                 if data == "2":
        #                     user_per.edit = True
        ...
        #         user_per.main_function = 4
        #         user_per.function_level = "employee_exit"
        #         user_per.sub_function_level = "employee_approval"
        #         user_per.sequence = 4
        #         user_per.sub_menu_sequence = 3
        #         user_per.save()
        ...
        #         UserAccessPermissonModelsPermission.objects.filter(main_function =4, sub_menu_sequence = 5).delete()
        #     user_per = UserPermission.AddEditPermission(request, 4, 5)
        ...
        #         user_per.main_function = 4
        #         user_per.function_level = "employee_exit"
        #         user_per.sub_function_level = "full_and_final"
        #         user_per.sequence = 4
        #         user_per.sub_menu_sequence = 5
        #         user_per.save()


        #     if not 'employee_exit_management_all' in request.POST and not 'employee_exit_management' in request.POST:
        #         UserAccessPermissonModelsPermission.objects.filter(main_function =4, sub_menu_sequence = 6).delete()
        #     user_per = UserPermission.AddEditPermission(request, 4, 6)
        #     if 'employee_exit_management_all' in request.POST or 'employee_exit_management' in request.POST:
        #         user_per.user_id = request.POST['user_id']
        #         if 'employee_exit_management_all' in request.POST  and request.POST['employee_exit_management_all'] == "0":
        #             user_per.add = True
        #             user_per.edit = True
        #             user_per.view = True
        #             user_per.delete = True
        #         else:
        #             for data in dict(request.POST)['employee_exit_management']:
        #                 if  data == "1":
        #                     user_per.add = True 
        #                 if data == "2":
        #                     user_per.edit = True
        ...
        #         user_per.main_function = 4
        #         user_per.function_level = "employee_exit"
        #         user_per.sub_function_level = "employee_exit_management"
        #         user_per.sequence = 4
        #         user_per.sub_menu_sequence = 6
        #         user_per.save()
        ...
        #         UserAccessPermissonModelsPermission.objects.filter(main_function =4, sub_menu_sequence = 7).delete()
        #     user_per = UserPermission.AddEditPermission(request, 4, 7)
        ...
        if 'attendance_overtime_management' in request.POST:
            ...
            if not 'attendance_polices_status_all' in request.POST and not 'attendance_polices_status' in request.POST:
            ...
            if 'attendance_polices_status_all' in request.POST or 'attendance_polices_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'attendance_polices_status_all' in request.POST  and request.POST['attendance_polices_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.sub_function_level = "attendance_polices"
                user_per.sequence = 8
                user_per.sub_menu_sequence = 1
                user_per.save()
            ...
            if not 'track_attendance_status_all' in request.POST and not 'track_attendance_status' in request.POST:
            ...
            if 'track_attendance_status_all' in request.POST or 'track_attendance_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'track_attendance_status_all' in request.POST  and request.POST['track_attendance_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['track_attendance_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 8
                user_per.function_level = "attendance_overtime_management"
                user_per.sub_function_level = "track_attendance"
                user_per.sequence = 8
                user_per.sub_menu_sequence = 2
                user_per.save()


            if not 'upload_attendance_status_all' in request.POST and not 'upload_attendance_status' in request.POST:
            ...
            if 'upload_attendance_status_all' in request.POST or 'upload_attendance_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'upload_attendance_status_all' in request.POST  and request.POST['upload_attendance_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
            ...
            if not 'attendance_modification_status_all' in request.POST and not 'attendance_modification_status' in request.POST:
            ...
            if 'attendance_modification_status_all' in request.POST or 'attendance_modification_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'attendance_modification_status_all' in request.POST  and request.POST['attendance_modification_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['attendance_modification_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 8
                user_per.function_level = "attendance_overtime_management"
                user_per.sub_function_level = "attendance_modification"
                user_per.sequence = 8
                user_per.sub_menu_sequence = 4
                user_per.save()

            if not 'attendance_approval_status_all' in request.POST and not 'attendance_approval_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =8, sub_menu_sequence = 5).delete()
            
            user_per = UserPermission.AddEditPermission(request, 8, 5)
            if 'attendance_approval_status_all' in request.POST or 'attendance_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'attendance_approval_status_all' in request.POST  and request.POST['attendance_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.main_function = 8
                user_per.function_level = "attendance_overtime_management"
                user_per.sub_function_level = "attendance_approval"
                user_per.sequence = 8
                user_per.sub_menu_sequence = 5
                user_per.save()


            if not 'overtime_policies_status_all' in request.POST and not 'overtime_policies_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =8, sub_menu_sequence = 6).delete()
            
            user_per = UserPermission.AddEditPermission(request, 8, 6)
            if 'overtime_policies_status_all' in request.POST or 'overtime_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'overtime_policies_status_all' in request.POST  and request.POST['overtime_policies_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['overtime_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 8
                user_per.function_level = "attendance_overtime_management"
                user_per.sub_function_level = "over_time_policies"
                user_per.sequence = 8
                user_per.sub_menu_sequence = 6
                user_per.save()
            ...
            if not 'overtime_policies_status_all' in request.POST and not 'overtime_policies_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =8, sub_menu_sequence = 7).delete()
            user_per = UserPermission.AddEditPermission(request, 8, 7)
            if 'overtime_policies_status_all' in request.POST or 'overtime_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'overtime_policies_status_all' in request.POST  and request.POST['overtime_policies_status_all'] == "0":
                    user_per.add = True
                ...
                user_per.main_function = 8
                user_per.function_level = "attendance_overtime_management"
                user_per.sub_function_level = "track_overtime"
                user_per.sequence = 8
                user_per.sub_menu_sequence = 7
                user_per.save()
            ...
            if not 'overtime_update_data_status_all' in request.POST and not 'overtime_update_data_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =8, sub_menu_sequence = 8).delete()
            user_per = UserPermission.AddEditPermission(request, 8, 8)
            if 'overtime_update_data_status_all' in request.POST or 'overtime_update_data_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'overtime_update_data_status_all' in request.POST  and request.POST['overtime_update_data_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['overtime_update_data_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 8
                user_per.function_level = "attendance_overtime_management"
                user_per.sub_function_level = "overtime_update_data"
                user_per.sequence = 8
                user_per.sub_menu_sequence = 8
                user_per.save()


            if not 'overtime_attendance_modification_status_all' in request.POST and not 'overtime_attendance_modification_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =8, sub_menu_sequence = 9).delete()
            user_per = UserPermission.AddEditPermission(request, 8, 9)
            if 'overtime_attendance_modification_status_all' in request.POST or 'overtime_attendance_modification_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'overtime_attendance_modification_status_all' in request.POST  and request.POST['overtime_attendance_modification_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['overtime_attendance_modification_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'overtime_approval_status_all' in request.POST and not 'overtime_approval_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =8, sub_menu_sequence = 10).delete()
            user_per = UserPermission.AddEditPermission(request, 8, 10)
            if 'overtime_approval_status_all' in request.POST or 'overtime_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'overtime_approval_status_all' in request.POST  and request.POST['overtime_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['overtime_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 8
                user_per.function_level = "attendance_overtime_management"
                user_per.sub_function_level = "overtime_approval"
                user_per.sequence = 8
                user_per.sub_menu_sequence = 10
                user_per.save()
        ...
        if 'travel_claim_management' in request.POST:
            ...
            if not 'travel_policies_status_all' in request.POST and not 'travel_policies_status' in request.POST:
            ...
            if 'travel_policies_status_all' in request.POST or 'travel_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'travel_policies_status_all' in request.POST  and request.POST['travel_policies_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['travel_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.sub_function_level = "travel_policies"
                user_per.sequence = 9
                user_per.sub_menu_sequence = 1
                user_per.save()

            if not 'travel_request_status_all' in request.POST and not 'travel_request_status' in request.POST:
            ...
            if 'travel_request_status_all' in request.POST or 'travel_request_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'travel_request_status_all' in request.POST  and request.POST['travel_request_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
            ...
            if not 'travel_approval_status_all' in request.POST and not 'travel_approval_status' in request.POST:
            ...
            if 'travel_approval_status_all' in request.POST or 'travel_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'travel_approval_status_all' in request.POST  and request.POST['travel_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['travel_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 9
                user_per.function_level = "travel_claim_management"
                user_per.sub_function_level = "travel_approval"
                user_per.sequence = 9
                user_per.sub_menu_sequence = 3
                user_per.save()

            if not 'travel_status_all' in request.POST and not 'travel_status' in request.POST:
            ...
            if 'travel_status_all' in request.POST or 'travel_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'travel_status_all' in request.POST  and request.POST['travel_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['travel_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 9
                user_per.function_level = "travel_claim_management"
                user_per.sub_function_level = "travel_status"
                user_per.sequence = 9
                user_per.sub_menu_sequence = 4
                user_per.save()

            if not 'travel_claim_status_all' in request.POST and not 'travel_claim_status' in request.POST:
            ...
            if 'travel_claim_status_all' in request.POST or 'travel_claim_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'travel_claim_status_all' in request.POST  and request.POST['travel_claim_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['travel_claim_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 9
                user_per.function_level = "travel_claim_management"
                user_per.sub_function_level = "travel_claim_status"
                user_per.sequence = 9
                user_per.sub_menu_sequence = 5
                user_per.save()

            if not 'claim_status_all' in request.POST and not 'claim_status' in request.POST:
            ...
            if 'claim_status_all' in request.POST or 'claim_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'claim_status_all' in request.POST  and request.POST['claim_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['claim_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
        ...
        if 'claims_and_reimbursement' in request.POST:
            ...
            if not 'claim_policies_status_all' in request.POST and not 'claim_policies_status' in request.POST:
            ...
            if 'claim_policies_status_all' in request.POST or 'claim_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'claim_policies_status_all' in request.POST  and request.POST['claim_policies_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['claim_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.sub_function_level = "claim_policies"
            ...
            if not 'claim_request_status_all' in request.POST and not 'claim_request_status' in request.POST:
            ...
            if 'claim_request_status_all' in request.POST or 'claim_request_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'claim_request_status_all' in request.POST  and request.POST['claim_request_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['claim_request_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'claim_approval_status_all' in request.POST and not 'claim_approval_status' in request.POST:
            ...
            if 'claim_approval_status_all' in request.POST or 'claim_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'claim_approval_status_all' in request.POST  and request.POST['claim_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['claim_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'status_claim_all' in request.POST and not 'status_claim' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =10, sub_menu_sequence = 4).delete()
            
            user_per = UserPermission.AddEditPermission(request, 9, 4)
            if 'status_claim_all' in request.POST or 'status_claim' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'status_claim_all' in request.POST  and request.POST['status_claim_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['status_claim']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
        ...
        #Leave Encashment 
        #---------
        if 'leave_encashment' in request.POST:

            if not 'encashment_polices_status_all' in request.POST and not 'encashment_polices_status' in request.POST:
            ...
            if 'encashment_polices_status_all' in request.POST or 'encashment_polices_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'encashment_polices_status_all' in request.POST  and request.POST['status_cencashment_polices_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['encashment_polices_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.function_level = "leave_encashment"
                user_per.sub_function_level = "encashment_policies"
                user_per.sequence = 11
                user_per.sub_menu_sequence = 1
                user_per.save()

            if not 'encashment_request_status_all' in request.POST and not 'encashment_request_status' in request.POST:
            ...
            if 'encashment_request_status_all' in request.POST or 'encashment_request_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'encashment_request_status_all' in request.POST  and request.POST['encashment_request_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['encashment_request_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 11
                user_per.function_level = "leave_encashment"
                user_per.sub_function_level = "encashment_request"
                user_per.sequence = 11
                user_per.sub_menu_sequence = 2
                user_per.save()


            if not 'encashment_approval_status_all' in request.POST and not 'encashment_approval_status' in request.POST:
            ...
            if 'encashment_approval_status_all' in request.POST or 'encashment_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'encashment_approval_status_all' in request.POST  and request.POST['encashment_approval_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['encashment_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 11
                user_per.function_level = "leave_encashment"
                user_per.sub_function_level = "encashment_approval"
                user_per.sequence = 11
                user_per.sub_menu_sequence = 3
                user_per.save()


            if not 'encashment_status_all' in request.POST and not 'encashment_status' in request.POST:
            ...
            if 'encashment_status_all' in request.POST or 'encashment_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'encashment_status_all' in request.POST  and request.POST['encashment_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['encashment_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 11
                user_per.function_level = "leave_encashment"
                user_per.sub_function_level = "encashment_status"
                user_per.sequence = 11
                user_per.sub_menu_sequence = 4
                user_per.save()
        ...
        if 'bonus_incentive' in request.POST:

            if not 'bonus_incentive_status_all' in request.POST and not 'bonus_incentive_status' in request.POST:
            ...
            if 'bonus_incentive_status_all' in request.POST or 'bonus_incentive_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'bonus_incentive_status_all' in request.POST  and request.POST['bonus_incentive_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['bonus_incentive_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.function_level = "bonus_incentive"
                user_per.sub_function_level = "bonus"
                user_per.sequence = 12
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'incentive_policies_status_all' in request.POST and not 'incentive_policies_status' in request.POST:
            ...
            if 'incentive_policies_status_all' in request.POST or 'incentive_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'incentive_policies_status_all' in request.POST  and request.POST['incentive_policies_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['incentive_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 12
                user_per.function_level = "bonus_incentive"
                user_per.sub_function_level = "incentive_policies"
                user_per.sequence = 12
                user_per.sub_menu_sequence = 2
                user_per.save()


            if not 'update_incentive_status_all' in request.POST and not 'update_incentive_status' in request.POST:
            ...
            if 'update_incentive_status_all' in request.POST or 'update_incentive_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'update_incentive_status_all' in request.POST  and request.POST['update_incentive_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['update_incentive_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 12
                user_per.function_level = "bonus_incentive"
                user_per.sub_function_level = "update_incentive"
                user_per.sequence = 12
                user_per.sub_menu_sequence = 3
                user_per.save()


            if not 'update_bonus_status_all' in request.POST and not 'update_bonus_status' in request.POST:
            ...
            if 'update_bonus_status_all' in request.POST or 'update_bonus_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'update_bonus_status_all' in request.POST  and request.POST['update_bonus_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['update_bonus_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 12
                user_per.function_level = "bonus_incentive"
                user_per.sub_function_level = "update_bonus"
                user_per.sequence = 12
                user_per.sub_menu_sequence = 4
                user_per.save()


            if not 'bonus_incentive_approval_status_all' in request.POST and not 'bonus_incentive_approval_status' in request.POST:
            ...
            if 'bonus_incentive_approval_status_all' in request.POST or 'bonus_incentive_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'bonus_incentive_approval_status_all' in request.POST  and request.POST['bonus_incentive_approval_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['bonus_incentive_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 12
                user_per.function_level = "bonus_incentive"
                user_per.sub_function_level = "bonus_incentive_apporval"
                user_per.sequence = 12
                user_per.sub_menu_sequence = 5
                user_per.save()
            ...
            if not 'bonus_incentives_status_all' in request.POST and not 'bonus_incentives_status' in request.POST:
            ...
            if 'bonus_incentives_status_all' in request.POST or 'bonus_incentives_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'bonus_incentives_status_all' in request.POST  and request.POST['bonus_incentives_status_all']=='0':
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['bonus_incentives_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 12
                user_per.function_level = "bonus_incentive"
                user_per.sub_function_level = "bonus_incentive_status"
                user_per.sequence = 12
                user_per.sub_menu_sequence = 6
                user_per.save()
        ...
        if 'employee_advances' in request.POST:
            ...
            if not 'advance_policies_status_all' in request.POST and not 'advance_policies_status' in request.POST:
            ...
            if 'advance_policies_status_all' in request.POST or 'advance_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'advance_policies_status_all' in request.POST  and request.POST['advance_policies_status'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['advance_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.sub_function_level = "policies"
                user_per.sequence = 13
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'advance_request_status_all' in request.POST and not 'advance_request_status' in request.POST:
            ...
            if 'advance_request_status_all' in request.POST or 'advance_request_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'advance_request_status_all' in request.POST  and request.POST['advance_request_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['advance_request_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 13
                user_per.function_level = "employee_advances"
                user_per.sub_function_level = "advance_request"
                user_per.sequence = 13
                user_per.sub_menu_sequence = 2
                user_per.save()

            if not 'advance_approval_status_all' in request.POST and not 'advance_approval_status' in request.POST:
            ...
            if 'advance_approval_status_all' in request.POST or 'advance_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'advance_approval_status_all' in request.POST  and request.POST['advance_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.main_function = 13
                user_per.function_level = "employee_advances"
                user_per.sub_function_level = "advance_approval"
                user_per.sequence = 13
                user_per.sub_menu_sequence = 3
                user_per.save()


            if not 'advance_status_all' in request.POST and not 'advance_status' in request.POST:
            ...
            if 'advance_status_all' in request.POST or 'advance_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'advance_status_all' in request.POST  and request.POST['advance_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['advance_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 13
                user_per.function_level = "employee_advances"
                user_per.sub_function_level = "advance_status"
                user_per.sequence = 13
                user_per.sub_menu_sequence = 4
                user_per.save()
        ...
        if 'perquisite' in request.POST:

            if not 'perquisite_policies_status_all' in request.POST and not 'perquisite_policies_status' in request.POST:
            ...
            if 'perquisite_policies_status_all' in request.POST or 'perquisite_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'perquisite_policies_status_all' in request.POST  and request.POST['perquisite_policies_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['perquisite_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.function_level = "perquisite"
                user_per.sub_function_level = "perquisite_policies"
                user_per.sequence = 14
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'perquisite_request_status_all' in request.POST and not 'perquisite_request_status' in request.POST:
            ...
            if 'perquisite_request_status_all' in request.POST or 'perquisite_request_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'perquisite_request_status_all' in request.POST  and request.POST['perquisite_request_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['perquisite_request_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 14
                user_per.function_level = "perquisite"
                user_per.sub_function_level = "perquisite_request"
                user_per.sequence = 14
                user_per.sub_menu_sequence = 2
                user_per.save()

            if not 'perquisite_approval_status_all' in request.POST and not 'perquisite_approval_status' in request.POST:
            ...
            if 'perquisite_approval_status_all' in request.POST or 'perquisite_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'perquisite_approval_status_all' in request.POST  and request.POST['perquisite_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['perquisite_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 14
                user_per.function_level = "perquisite"
                user_per.sub_function_level = "perquisite_approval"
                user_per.sequence = 14
                user_per.sub_menu_sequence = 3
                user_per.save()

            if not 'perquisite_status_all' in request.POST and not 'perquisite_status' in request.POST:
            ...
            if 'perquisite_status_all' in request.POST or 'perquisite_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'perquisite_status_all' in request.POST  and request.POST['perquisite_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['perquisite_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 14
                user_per.function_level = "perquisite"
                user_per.sub_function_level = "perquisite_status"
                user_per.sequence = 14
                user_per.sub_menu_sequence = 4
                user_per.save()
        ...
        # #  Tax and Benifits 
        # # -------------------
        if 'tax_declaration' in request.POST:

            if not 'tax_policies_status_all' in request.POST and not 'tax_policies_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =15, sub_menu_sequence = 1).delete()
            
            user_per = UserPermission.AddEditPermission(request, 15, 1)
            if 'tax_policies_status_all' in request.POST or 'tax_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'tax_policies_status_all' in request.POST  and request.POST['tax_policies_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['tax_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 15
                user_per.function_level = "tax_declaration"
                user_per.sub_function_level = "tax_policies"
                user_per.sequence = 15
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'tax_declaration_status_all' in request.POST and not 'tax_declaration_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =15, sub_menu_sequence = 2).delete()
            
            user_per = UserPermission.AddEditPermission(request, 15, 2)
            if 'tax_declaration_status_all' in request.POST or 'tax_declaration_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'tax_declaration_status_all' in request.POST  and request.POST['tax_declaration_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.main_function = 15
                user_per.function_level = "tax_declaration"
                user_per.sub_function_level = "declaration"
                user_per.sequence = 15
                user_per.sub_menu_sequence = 2
                user_per.save()
            ...
            if not 'tax_approval_status_all' in request.POST and not 'tax_approval_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =15, sub_menu_sequence = 3).delete()
            
            user_per = UserPermission.AddEditPermission(request, 15, 3)
            if 'tax_approval_status_all' in request.POST or 'tax_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'tax_approval_status_all' in request.POST  and request.POST['tax_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['tax_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 15
                user_per.function_level = "tax_declaration"
                user_per.sub_function_level = "tax_approval"
                user_per.sequence = 15
                user_per.sub_menu_sequence = 3
                user_per.save()
            ...
            if not 'declaration_status_all' in request.POST and not 'declaration_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =15, sub_menu_sequence = 4).delete()
            
            user_per = UserPermission.AddEditPermission(request, 15, 4)
            if 'declaration_status_all' in request.POST or 'declaration_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'declaration_status_all' in request.POST  and request.POST['declaration_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['declaration_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 15
                user_per.function_level = "tax_declaration"
                user_per.sub_function_level = "declaration_status"
                user_per.sequence = 15
                user_per.sub_menu_sequence = 4
                user_per.save()


            if not 'tax_calculation_status_all' in request.POST and not 'tax_calculation_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =15, sub_menu_sequence = 5).delete()
            
            user_per = UserPermission.AddEditPermission(request, 15, 5)
            if 'tax_calculation_status_all' in request.POST or 'tax_calculation_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'tax_calculation_status_all' in request.POST  and request.POST['tax_calculation_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['tax_calculation_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 15
                user_per.function_level = "tax_declaration"
                user_per.sub_function_level = "tax_calculation"
                user_per.sequence = 15
                user_per.sub_menu_sequence = 5
                user_per.save()


        if 'recoveries' in request.POST:

            if not 'recovery_policies_status_all' in request.POST and not 'recovery_policies_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =16, sub_menu_sequence = 1).delete()
            
            user_per = UserPermission.AddEditPermission(request, 16, 1)
            if 'recovery_policies_status_all' in request.POST or 'recovery_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'recovery_policies_status_all' in request.POST  and request.POST['recovery_policies_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['recovery_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 16
                user_per.function_level = "recoveries"
                user_per.sub_function_level = "recovery_policies"
                user_per.sequence = 16
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'recoveries_status_all' in request.POST and not 'recoveries_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =16, sub_menu_sequence = 2).delete()
            
            user_per = UserPermission.AddEditPermission(request, 16, 2)
            if 'recoveries_status_all' in request.POST or 'recoveries_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'recoveries_status_all' in request.POST  and request.POST['recoveries_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['recoveries_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 16
                user_per.function_level = "recoveries"
                user_per.sub_function_level = "recoveries_status"
                user_per.sequence = 16
                user_per.sub_menu_sequence = 2
                user_per.save()

            if not 'approval_status_all' in request.POST and not 'approval_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =16, sub_menu_sequence = 3).delete()
            
            user_per = UserPermission.AddEditPermission(request, 16, 3)
            if 'approval_status_all' in request.POST or 'approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'approval_status_all' in request.POST  and request.POST['approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 16
                user_per.function_level = "recoveries"
                user_per.sub_function_level = "approval_status"
                user_per.sequence = 16
                user_per.sub_menu_sequence = 3
                user_per.save()

            if not 'recovery_status_all' in request.POST and not 'recovery_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =16, sub_menu_sequence = 4).delete()
            
            user_per = UserPermission.AddEditPermission(request, 16, 4)
            if 'recovery_status_all' in request.POST or 'recovery_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'recovery_status_all' in request.POST  and request.POST['recovery_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['recovery_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 16
                user_per.function_level = "recoveries"
                user_per.sub_function_level = "recovery_status"
                user_per.sequence = 16
                user_per.sub_menu_sequence = 4
                user_per.save()
        ...
        if 'payroll_process' in request.POST :
            ...
            if not 'data_update_status_all' in request.POST and not 'data_update_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 1).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 1)
            if 'data_update_status_all' in request.POST or 'data_update_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'data_update_status_all' in request.POST  and request.POST['data_update_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['data_update_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "data_update"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 1
                user_per.save()

            if not 'payroll_processing_status_all' in request.POST and not 'payroll_processing_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 2).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 2)
            if 'payroll_processing_status_all' in request.POST or 'payroll_processing_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'payroll_processing_status_all' in request.POST  and request.POST['payroll_processing_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['payroll_processing_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "status"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 2
                user_per.save()

            if not 'payroll_approval_status_all' in request.POST and not 'payroll_approval_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 3).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 3)
            if 'payroll_approval_status_all' in request.POST or 'payroll_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'payroll_approval_status_all' in request.POST  and request.POST['payroll_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['payroll_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "payroll_approval"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 3
                user_per.save()

            if not 'payroll_disbursement_status_all' in request.POST and not 'payroll_disbursement_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 4).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 4)
            if 'payroll_disbursement_status_all' in request.POST or 'payroll_disbursement_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'payroll_disbursement_status_all' in request.POST  and request.POST['payroll_disbursement_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['payroll_disbursement_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "payroll_disbursement"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 4
                user_per.save()


            if not 'payroll_voucher_status_all' in request.POST and not 'payroll_voucher_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 5).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 5)
            if 'payroll_voucher_status_all' in request.POST or 'payroll_voucher_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'payroll_voucher_status_all' in request.POST  and request.POST['payroll_voucher_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['payroll_voucher_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "payroll_voucher"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 5
                user_per.save()


            if not 'salary_slips_status_all' in request.POST and not 'salary_slips_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 6).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 6)
            if 'salary_slips_status_all' in request.POST or 'salary_slips_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'salary_slips_status_all' in request.POST  and request.POST['salary_slips_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['salary_slips_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "salary_slips"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 6
                user_per.save()

            if not 'tax_statements_status_all' in request.POST and not 'tax_statements_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 7).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 7)
            if 'tax_statements_status_all' in request.POST or 'tax_statements_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'tax_statements_status_all' in request.POST  and request.POST['tax_statements_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['tax_statements_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "tax_statements"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 7
                user_per.save()


            if not 'income_tax_status_all' in request.POST and not 'income_tax_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 8).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 8)
            if 'income_tax_status_all' in request.POST or 'income_tax_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'income_tax_status_all' in request.POST  and request.POST['income_tax_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['income_tax_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "income_tax"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 8
                user_per.save()


            if not 'entertainment_tax_status_all' in request.POST and not 'entertainment_tax_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 9).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 9)
            if 'entertainment_tax_status_all' in request.POST or 'entertainment_tax_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'entertainment_tax_status_all' in request.POST  and request.POST['entertainment_tax_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['entertainment_tax_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "entertainment_tax"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 9
                user_per.save()


            if not 'professional_tax_status_all' in request.POST and not 'professional_tax_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 10).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 10)
            if 'professional_tax_status_all' in request.POST or 'professional_tax_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'professional_tax_status_all' in request.POST  and request.POST['professional_tax_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['professional_tax_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'provident_fund_status_all' in request.POST and not 'provident_fund_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 10).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 11)
            if 'provident_fund_status_all' in request.POST or 'provident_fund_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'provident_fund_status_all' in request.POST  and request.POST['provident_fund_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['provident_fund_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 17
                user_per.function_level = "payroll_process"
                user_per.sub_function_level = "payroll_fund"
                user_per.sequence = 17
                user_per.sub_menu_sequence = 11
                user_per.save()
            ...
            if not 'esic_status_all' in request.POST and not 'esic_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 12).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 12)
            if 'esic_status_all' in request.POST or 'esic_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'esic_status_all' in request.POST  and request.POST['esic_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
            ...
            if not 'advance_status_all' in request.POST and not 'advance_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 13).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 13)
            if 'advance_status_all' in request.POST or 'advance_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'advance_status_all' in request.POST  and request.POST['advance_status_all'] == "0":
                    user_per.add = True
            ...
            if not 'other_recoveries_status_all' in request.POST and not 'other_recoveries_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =17, sub_menu_sequence = 14).delete()
            
            user_per = UserPermission.AddEditPermission(request, 17, 14)
            if 'other_recoveries_status_all' in request.POST or 'other_recoveries_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'other_recoveries_status_all' in request.POST  and request.POST['other_recoveries_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['other_recoveries_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
        ...
        #  Policies & Forms 
        # -------------------
        if 'performance_appraisal' in request.POST:

            if not 'appraisal_policies_status_all' in request.POST and not 'appraisal_policies_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =18, sub_menu_sequence = 1).delete()
            
            user_per = UserPermission.AddEditPermission(request, 18, 1)
            if 'policies_forms_update_policies_all' in request.POST or 'appraisal_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'policies_forms_update_policies_all' in request.POST  and request.POST['policies_forms_update_policies_all'] == "0":
                    ...
                    for data in dict(request.POST)['appraisal_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 18
                user_per.function_level = "policies_forms"
                user_per.sub_function_level = "appraisal_policies"
                user_per.sequence = 18
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'appraisal_request_status_all' in request.POST and not 'appraisal_request_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =18, sub_menu_sequence = 2).delete()
            
            user_per = UserPermission.AddEditPermission(request, 18, 2)
            if 'appraisal_request_status_all' in request.POST or 'appraisal_request_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'appraisal_request_status_all' in request.POST  and request.POST['appraisal_request_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['appraisal_request_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 18
                user_per.function_level = "policies_forms"
                user_per.sub_function_level = "appraisal_request"
                user_per.sequence = 18
                user_per.sub_menu_sequence = 2
                user_per.save()

            if not 'appraisal_grading_status_all' in request.POST and not 'appraisal_grading_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =18, sub_menu_sequence = 3).delete()
            
            user_per = UserPermission.AddEditPermission(request, 18, 3)
            if 'appraisal_grading_status_all' in request.POST or 'appraisal_grading_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'appraisal_grading_status_all' in request.POST  and request.POST['appraisal_grading_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['appraisal_grading_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'appraisal_approval_status_all' in request.POST and not 'appraisal_approval_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =18, sub_menu_sequence = 4).delete()
            
            user_per = UserPermission.AddEditPermission(request, 18, 4)
            if 'appraisal_approval_status_all' in request.POST or 'appraisal_approval_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'appraisal_approval_status_all' in request.POST  and request.POST['appraisal_approval_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['appraisal_approval_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 18
                user_per.function_level = "policies_forms"
                user_per.sub_function_level = "appraisal_approval"
                user_per.sequence = 18
                user_per.sub_menu_sequence = 4
                user_per.save()


            if not 'appraisal_status_all' in request.POST and not 'appraisal_status' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =18, sub_menu_sequence = 5).delete()
            
            user_per = UserPermission.AddEditPermission(request, 18, 5)
            if 'appraisal_status_all' in request.POST or 'appraisal_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'appraisal_status_all' in request.POST  and request.POST['appraisal_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['appraisal_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 18
                user_per.function_level = "policies_forms"
                user_per.sub_function_level = "appraisal"
                user_per.sequence = 18
                user_per.sub_menu_sequence = 5
                user_per.save()
        ...
        if 'learning_development' in request.POST:

            if not 'product_learning_status_all' in request.POST and not 'product_learning_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =19, sub_menu_sequence = 1).delete()
            user_per = UserPermission.AddEditPermission(request, 19, 1)
            if 'product_learning_status_all' in request.POST or 'product_learning_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'product_learning_status_all' in request.POST  and request.POST['product_learning_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['product_learning_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 19
                user_per.function_level = "learning_development"
                user_per.sub_function_level = "product_learning"
                user_per.sequence = 19
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'trainigs_status_all' in request.POST and not 'trainigs_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =19, sub_menu_sequence = 2).delete()
            user_per = UserPermission.AddEditPermission(request, 19, 2)
            if 'trainigs_status_all' in request.POST or 'trainigs_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'trainigs_status_all' in request.POST  and request.POST['trainigs_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['trainigs_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 19
                user_per.function_level = "learning_development"
                user_per.sub_function_level = "trainings_status"
                user_per.sequence = 19
                user_per.sub_menu_sequence = 2
                user_per.save()
        ...
        if 'hr_policies_form' in request.POST:

            if not 'hr_policies_status_all' in request.POST and not 'hr_policies_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =20, sub_menu_sequence = 1).delete()
            user_per = UserPermission.AddEditPermission(request, 20, 1)
            if 'hr_policies_status_all' in request.POST or 'hr_policies_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'hr_policies_status_all' in request.POST  and request.POST['hr_policies_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['hr_policies_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 20
                user_per.function_level = "hr_policies_form"
                user_per.sub_function_level = "hr_policies"
                user_per.sequence = 20
                user_per.sub_menu_sequence = 1
                user_per.save()


            if not 'form_status_all' in request.POST and not 'form_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =20, sub_menu_sequence = 2).delete()
            user_per = UserPermission.AddEditPermission(request, 20, 2)
            if 'form_status_all' in request.POST or 'form_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'form_status_all' in request.POST  and request.POST['form_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                ...
                user_per.main_function = 20
                user_per.function_level = "hr_policies_form"
                user_per.sub_function_level = "form_status"
                user_per.sequence = 20
                user_per.sub_menu_sequence = 2
                user_per.save()

        if 'Complainces' in request.POST:
            if not 'complainces_status_all' in request.POST and not 'complainces_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =21, sub_menu_sequence = 1).delete()
            user_per = UserPermission.AddEditPermission(request, 21, 1)
            if 'complainces_status_all' in request.POST or 'complainces_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'complainces_status_all' in request.POST  and request.POST['complainces_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['perquisite_request_all']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 21
                user_per.function_level = "Complainces"
                user_per.sub_function_level = "complainces_status"
                user_per.sequence = 21
                user_per.sub_menu_sequence = 1
                user_per.save()
        ...
        if 'reports' in request.POST:
            ...
            if not 'reports_status_all' in request.POST and not 'reports_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =22, sub_menu_sequence = 1).delete()
            user_per = UserPermission.AddEditPermission(request, 22, 1)
            if 'reports_status_all' in request.POST or 'reports_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'reports_status_all' in request.POST  and request.POST['reports_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['reports_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 22
                user_per.function_level = "Complainces"
                user_per.sub_function_level = "complainces_status"
                user_per.sequence = 22
                user_per.sub_menu_sequence = 1
                user_per.save()

        if 'message_notification' in request.POST:

            if not 'message_notification_status_all' in request.POST and not 'message_notification_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =23, sub_menu_sequence = 1).delete()
            user_per = UserPermission.AddEditPermission(request, 23, 1)
            if 'message_notification_status_all' in request.POST or 'message_notification_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'message_notification_status_all' in request.POST  and request.POST['message_notification_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['message_notification_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 23
                user_per.function_level = "message_notification"
                user_per.sub_function_level = "message"
                user_per.sequence = 23
                user_per.sub_menu_sequence = 1
                user_per.save()
        ...
        if 'help_desk' in request.POST:

            if not 'status_all' in request.POST and not 'status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =24, sub_menu_sequence = 2).delete()
            user_per = UserPermission.AddEditPermission(request, 24, 2)
            if 'status_all' in request.POST or 'status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'status_all' in request.POST  and request.POST['status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                        ...
                        if data == "4":
                            user_per.delete = True
                user_per.main_function = 24
                user_per.function_level = "help_desk"
                user_per.sub_function_level = "status"
                user_per.sequence = 24
                user_per.sub_menu_sequence = 2
                user_per.save()


            if not 'new_concern_status_all' in request.POST and not 'new_concern_status' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =24, sub_menu_sequence = 1).delete()
            user_per = UserPermission.AddEditPermission(request, 24, 1)
            if 'new_concern_status_all' in request.POST or 'new_concern_status' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'new_concern_status_all' in request.POST  and request.POST['new_concern_status_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['new_concern_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
        ...
        if "perquisite" in request.POST:
            ...
            if not 'perquisite_request_all' in request.POST and not 'perquisite_request' in request.POST:
                    UserAccessPermissonModelsPermission.objects.filter(main_function =15, sub_menu_sequence = 1).delete()
            user_per = UserPermission.AddEditPermission(request, 15, 1)
            if 'perquisite_request_all' in request.POST or 'perquisite_request' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'perquisite_request_all' in request.POST  and request.POST['perquisite_request_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
            ...
            if not 'perquisite_approve_all' in request.POST and not 'perquisite_approve' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =15, sub_menu_sequence = 2).delete()
            user_per = UserPermission.AddEditPermission(request, 15, 2)
            if 'perquisite_approve_all' in request.POST or 'perquisite_approve' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'perquisite_approve_all' in request.POST  and request.POST['perquisite_approve_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['perquisite_approve_all']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 15
                user_per.function_level = "perquisite"
                user_per.sub_function_level = "perquisite_approve"
                user_per.sequence = 15
                user_per.sub_menu_sequence = 2
                user_per.save()
        ...
        if 'tax_declaration' in request.POST:
            ...
            if 'tax_declaration_status_all' in request.POST or 'tax_declaration_status' in request.POST:
                ...
                if 'tax_declaration_status_all' in request.POST  and request.POST['tax_declaration_status_all'] == "0":
                    ...
                    for data in dict(request.POST)['tax_declaration_status']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 16
                user_per.function_level = "tax_declaration"
                user_per.sub_function_level = "tax_declaration"
                user_per.sequence = 16
                user_per.sub_menu_sequence = 2
                user_per.save()
            ...
            if not 'tax_approval_all' in request.POST and not 'tax_approval' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =16, sub_menu_sequence = 4).delete()
            
            user_per = UserPermission.AddEditPermission(request, 16, 4)
            if 'tax_approval_all' in request.POST or 'tax_approval' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'tax_approval_all' in request.POST  and request.POST['tax_approval_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['tax_approval_all']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
            ...
            if not 'other_recoveries_all' in request.POST and not 'other_recoveries' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =16, sub_menu_sequence = 5).delete()
            
            user_per = UserPermission.AddEditPermission(request, 16, 5)
            if 'other_recoveries_all' in request.POST or 'other_recoveries' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'other_recoveries_all' in request.POST  and request.POST['other_recoveries_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['other_recoveries_all']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 16
                user_per.function_level = "tax_declaration"
                user_per.sub_function_level = "other_recoveries_all"
                user_per.sequence = 16
                user_per.sub_menu_sequence = 5
                user_per.save()


            if not 'recovery_approval_all' in request.POST and not 'recovery_approval' in request.POST:
                UserAccessPermissonModelsPermission.objects.filter(main_function =16, sub_menu_sequence = 6).delete()
            
            user_per = UserPermission.AddEditPermission(request, 16, 6)
            if 'recovery_approval_all' in request.POST or 'recovery_approval' in request.POST:
                user_per.user_id = request.POST['user_id']
                if 'recovery_approval_all' in request.POST  and request.POST['other_recoveries_all'] == "0":
                    user_per.add = True
                    user_per.edit = True
                    user_per.view = True
                    user_per.delete = True
                else:
                    for data in dict(request.POST)['recovery_approval_all']:
                        if  data == "1":
                            user_per.add = True 
                        if data == "2":
                            user_per.edit = True
                ...
                user_per.main_function = 16
                user_per.function_level = "tax_declaration"
                user_per.sub_function_level = "recovery_approval_all"
                user_per.sequence = 16
                user_per.sub_menu_sequence = 6
                user_per.save()
