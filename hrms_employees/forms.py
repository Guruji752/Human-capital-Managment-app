...
class ManageGradeForm(forms.ModelForm):
    ...
    class Meta:
        model = ManageGrade
        fields = ('grade_type','department', 'designation' , 'is_active')
        widgets = {
...
class ManageSalaryRangeForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('grade','department' ,'designation' ,'start_salary', 'is_active')
        widgets = {
...
class ManageQualificationForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('qualification', 'description', 'is_active')
        widgets = {
...
class ManageExpereinceForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('experience_type', 'description', 'is_active')
        widgets = {
