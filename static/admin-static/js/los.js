...
$('#upload_documents_upload_btn').click(function(e){
  // debugger
  e.preventDefault();
        data = new FormData($('#upload_documents_upload').get(0));        
        $.ajax({
            url : $("#upload_document").val(),
            type: "POST",
            data:  data,
            contentType: false,
            processData: false,
...
$('#upload_verification_btn').click(function(e){
  // debugger
  e.preventDefault();
        data = new FormData($('#upload_verification_upload').get(0));        
        $.ajax({
            url : $("#upload_verification").val(),
            type: "POST",
            data:  data,
            contentType: false,
            processData: false,
